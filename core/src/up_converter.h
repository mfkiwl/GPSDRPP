 ...
 *  - pull down pin 38(4B1 on Vivid Unit) to control RF switches, which puts itself into the signal path.
 *  - call sigpath::sourceManager.setTuningOffset() to set the tunning offset.
 */

#define UP_CONVERTER_CMD_ALT_0      "vgp alt 38 0"
#define UP_CONVERTER_CMD_MODE_OUT   "vgp mode 38 OUT"
#define UP_CONVERTER_CMD_SET_HIGH   "vgp set 38 1"
#define UP_CONVERTER_CMD_SET_LOW    "vgp set 38 0"
